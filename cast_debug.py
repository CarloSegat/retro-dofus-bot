"""Debug: cast Sacrid Foot exactly once, 5 seconds after launch.
...
Optional flags:
  --hotkey K     spell hotkey to press     (default: config sacrid_foot_hotkey, fall back to "2")
...
def main():
    ...
    p.add_argument("--hotkey", default=CFG.get("sacrid_foot_hotkey") or "2")
